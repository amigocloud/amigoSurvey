...
import com.amigocloud.amigosurvey.repository.amigoApiInterface
import com.amigocloud.amigosurvey.repository.disposable
...
class LoginActivity : AppCompatActivity(), LoaderCallbacks<Cursor> {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        Repository.instance.login(email = "victor@amigocloud.com", password = "vchernet757", context = this)
